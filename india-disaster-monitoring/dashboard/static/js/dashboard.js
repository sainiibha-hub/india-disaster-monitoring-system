/* ==========================================================================
   India Disaster Monitor -- dashboard front-end logic
   Fetches from the Flask API endpoints and renders the map, ticker panels,
   trend chart and top-states table. Polls every 60s to stay "live".
   ========================================================================== */
...
async function loadAll() {
  const [summary, rainfall, floods, quakes, cyclones, trend, topStates] = await Promise.all([
    getJSON("/api/summary"),
    getJSON("/api/rainfall/latest"),
    getJSON("/api/floods"),
    getJSON("/api/earthquakes"),
    getJSON("/api/cyclones"),
    getJSON("/api/rainfall/trend"),
    getJSON("/api/rainfall/top-states"),
  ]);
